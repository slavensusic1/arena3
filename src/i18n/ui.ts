...
export const routes = {
  ...
  export const ui = {
    en: {
      ...
      'yearsHelping':"Years Helping Business",
      'workingEmp':"Working Employees",
      'completedPro':"Complete Projects",
...
'portfolio.Miscellaneous':'Miscellaneous',
      ...
      'about.Growth':"Growth is not just a destination; it's a continuous journey. At [Your Company Name], we nurture an environment that encourages individual and collective growth. Our commitment to personal and professional development ensures that each team member and the organization as a whole is on a trajectory of constant improvement. As we grow, so does our capacity to deliver exceptional value to our clients and stakeholders.",
...
'work.proces.ProjectText': "U Digital Areni, svaki projekt je odraz vrhunske točnosti i predanog rada.  Od početne ideje do finalne realizacije, jamčimo nesmetanu i uspješnu provedbu svakog projekta.",
       ...
       'ser.ict-text':'U digitalnoj areni specijalizirani smo za izgradnju i održavanje najsuvremenije ICT infrastrukture. Naš predani tim predan je izgradnji i održavanju svih vrsta infrastrukture potrebne za besprijekorne podatkovne usluge.' ,
